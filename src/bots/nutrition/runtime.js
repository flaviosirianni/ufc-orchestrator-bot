...
async function inferMealIntakeFromImage({
  ...
  const instructions = [
    ...
    '}',
    'Reglas:',
    '- PRIORIDAD TEXTO: Si el usuario proporcionó texto descriptivo (no vacío), ese texto es la fuente de verdad sobre QUÉ ítems registrar. No añadas ítems de la imagen que el usuario no mencionó ni reemplaces ítems del texto por lo que creés ver visualmente.',
    '- Usá la imagen solo para estimar porciones/cantidades de ítems ya mencionados en el texto cuando no estén especificadas en él.',
    '- Si llegan múltiples fotos en el mismo mensaje, tratarlas como parte de la misma comida y consolidar items sin duplicar.',
    '- Si una foto muestra otro plato/componente de la misma comida, incluirlo como item adicional (solo si no hay texto que describa los ítems).',
