...
const SUITES = [
  ...
  { modulePath: './ufcDataScrapper.test.js', exportName: 'runUfcDataScrapperTests' },
  ...
  {
    modulePath: './ufcOperationalSnapshot.test.js',
    exportName: 'runUfcOperationalSnapshotTests',
  },
];
