...
| UFC-STAB-005 | alta | VERIFYING | UFC-STAB-001 | Endurecer el runner para fallar ante errores de background, unhandled rejections y timers abiertos. | El incidente de `toolsHandlers` falla en RED y queda verde sólo al esperar/cancelar el refresh. | RED confirmó 1 lectura indebida; GREEN sirve SQLite sin I/O oculto. Runner estricto y suite completa verdes; marcar `DONE` junto con el deploy/verificación de Etapa 0. |
