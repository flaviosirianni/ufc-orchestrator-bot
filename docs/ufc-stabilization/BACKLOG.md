...
| UFC-STAB-101 | crítica | IN_PROGRESS | UFC-STAB-100 | Aplicar gate a proyecciones, scoring, news, mirrors y auto-settlement; exigir stats frescas. | Stats vencidas no escriben snapshots ni cierran apuestas; la apuesta abierta permanece igual. | Escribir tests RED por consumidor y demostrar digest ledger idéntico antes/después. |
