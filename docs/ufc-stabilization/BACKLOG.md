...
| UFC-STAB-102 | crítica | IN_PROGRESS | UFC-STAB-100 | Hash determinístico e índices de dedupe para projection/scoring. | Fake clock 24 h inserta sólo snapshot inicial y cambios reales. | Escribir test RED de inserción repetida y cambio material; migración aditiva con hashes/índices únicos. |
